...
class ViewBooked(private val dataList: List<Booked>) : RecyclerView.Adapter<ViewBooked.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.booked_item, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val bookedname: TextView = itemView.findViewById<TextView>(R.id.bookedname)
