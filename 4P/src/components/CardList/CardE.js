...
function CardE() {
  ...
  const handleLike = (e) => {
    ...
    sample1.doc("user1@user.com").set({숙소5이름: "신라스테이 제주", 숙소5예약날짜: "friday10", 숙소5체크: "1"});
    sample1.doc("user2@user.com").set({숙소5이름: "신라스테이 제주", 숙소5예약날짜: "friday10", 숙소5체크: "1"});
    sample1.doc("user3@user.com").set({숙소5이름: "신라스테이 제주", 숙소5예약날짜: "friday10", 숙소5체크: "1"});
    e.stopPropagation();
    setIsLiked(!isLiked);
  };
