...
function CardG() {
  ...
  const handleLike = (e) => {
    ...
    sample1.doc("user1@user.com").set({숙소7이름: "해비치 호텔&리조트", 숙소7예약날짜: "friday13", 숙소7체크: "1"});
    sample1.doc("user2@user.com").set({숙소7이름: "해비치 호텔&리조트", 숙소7예약날짜: "friday13", 숙소7체크: "1"});
    sample1.doc("user3@user.com").set({숙소7이름: "해비치 호텔&리조트", 숙소7예약날짜: "friday13", 숙소7체크: "1"});
    e.stopPropagation();
    setIsLiked(!isLiked);
  };
