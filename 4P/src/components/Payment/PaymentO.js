...
import "../Payment.css";
import PaymentCardO from "../PaymentCard/PaymentCardO";
...
const PaymentO = () => {
  ...
  const Pay_toss = () => {
    ...
    sample1.doc("user1@user.com").update({숙소15이름: "시그니엘 부산", 숙소15예약날짜: "wednesday11", 숙소15체크: "0"});
    sample1.doc("user2@user.com").update({숙소15이름: "시그니엘 부산", 숙소15예약날짜: "wednesday11", 숙소15체크: "0"});
    sample1.doc("user3@user.com").update({숙소15이름: "시그니엘 부산", 숙소15예약날짜: "wednesday11", 숙소15체크: "0"});
    const { IMP } = window;
