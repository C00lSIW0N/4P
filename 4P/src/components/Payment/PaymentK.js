...
import "../Payment.css";
import PaymentCardK from "../PaymentCard/PaymentCardK";
...
const PaymentK = () => {
  ...
  const Pay_toss = () => {
    ...
    sample1.doc("user1@user.com").set({숙소11이름: "제주 샹그릴라 호텔", 숙소11예약날짜: "friday17", 숙소11체크: "0"});
    sample1.doc("user2@user.com").set({숙소11이름: "제주 샹그릴라 호텔", 숙소11예약날짜: "friday17", 숙소11체크: "0"});
    sample1.doc("user3@user.com").set({숙소11이름: "제주 샹그릴라 호텔", 숙소11예약날짜: "friday17", 숙소11체크: "0"});
    const { IMP } = window;
  ...
  const Pay_payco = () => {
    const sample1 = firestore.collection("user");
    sample1.doc("user1@user.com").update({숙소11이름: "제주 샹그릴라 호텔", 숙소11예약날짜: "friday17", 숙소11체크: "0"});
    sample1.doc("user2@user.com").update({숙소11이름: "제주 샹그릴라 호텔", 숙소11예약날짜: "friday17", 숙소11체크: "0"});
    sample1.doc("user3@user.com").update({숙소11이름: "제주 샹그릴라 호텔", 숙소11예약날짜: "friday17", 숙소11체크: "0"});
    const { IMP } = window;
    IMP.init("imp02656648");
